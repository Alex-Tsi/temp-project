...
public class GmailIncomingTest {
    ...
    public static void main(String[] args) throws Exception {
        GmailIncomingTest gmailIncomingTest = new GmailIncomingTest();
        gmailIncomingTest.login("imap.gmail.com", "alekscypushtanov@gmail.com", "hbkhsbngzbvfhzot");
        System.out.println(gmailIncomingTest.getMessageCount());
        Message[] m = gmailIncomingTest.getMessages();
